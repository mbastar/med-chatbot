...
async def answer(input_data):
    # Assuming this is a placeholder for your logic
    # Replace with your actual logic
    return {"output": "some answer"}

@app.post("/")
async def main(query: Query):
    query_text = query.query
    content = await answer({"input": query_text})
    actual_content = content['output']
    return {"answer": actual_content}
